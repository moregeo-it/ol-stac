 ...
 * @module ol/proj
 */
import { isRegistered as isProj4Registered, register as registerProj4, } from 'ol/proj/proj4.js';
...
export async function registerProjection(proj, type, lookup = null) {
    ...
    if (type === 'code' && !lookup) {
        throw new Error('A lookup function must be provided to resolve projection definitions from codes');
    }
