import { c as register, o as proj4, r as getClassificationClasses, t as STACLayer, u as Map } from "./common.js";
//#region examples/stac-item-classification.js
register(proj4);
var layer = new STACLayer({
	...
	data: {
		...
		geometry: {
			type: "Polygon",
			coordinates: [[
				[-.49896480277672595, 39.69750082538408],
				[-.45024906258962005, 38.70992952974502],
				[.8113363003621146, 38.740378746353734],
				[.7803878365963612, 39.72903403736024],
				[-.49896480277672595, 39.69750082538408]
			]]
		},
		bbox: [
		...
		assets: { scl: {
			...
			"classification:classes": [
				...
				},
				{
					...
					description: "Topographic casted shadows (formerly \"Dark features/Shadows\")",
					color_hint: "2F2F2F"
				},
				{
					value: 3,
...
layer.on("sourceready", () => {
	...
	const asset = layer.getData().getAsset("scl");
	...
	for (const cls of classes) {
		...
		row.appendChild(document.createTextNode(cls.description || cls.title || cls.name));
		legend.appendChild(row);
	}
});
//#endregion

//# sourceMappingURL=stac-item-classification.js.map